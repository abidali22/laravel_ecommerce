                        ...
                        <div class="row">
                                ...
                                <article class="first-post mb-30 wow fadeIn animated hover-up">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="mb-20 entry-meta meta-2">
                                            <div class="font-xs ">
                                                <span class="post-by">By <a href="{{ route('blog') }}">Azimeto</a></span>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        <a href="blog-details.html">
                                            <img src="{{asset('assets/imgs/blog/blog-2.jpg')}}" alt="">
                                        </a>
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="{{ route('blog') }}">Politic</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        <a href="blog-details.html">
                                            <img src="{{asset('assets/imgs/blog/blog-8.jpg')}}" alt="">
                                        </a>
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="{{ route('blog') }}">Global</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        ...
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="{{ route('blog') }}">Sport</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        ...
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="{{ route('blog') }}">Technology</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        ...
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="{{ route('blog') }}">Watch</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        <a href="blog-details.html">
                                            <img src="{{asset('assets/imgs/blog/blog-9.jpg')}}" alt="">
                                        </a>
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="{{ route('blog') }}">Politic</a>
                                        </div>
                    ...
                    <div class="widget-area">
                        ...
                        <div class="sidebar-widget widget_categories mb-40">
                            ...
                            <div class="post-block-list post-module-1 post-module-5">
                                <ul>
                                    <li class="cat-item cat-item-2"><a href="{{ route('blog') }}">Beauty</a> (3)</li>
                                    <li class="cat-item cat-item-3"><a href="{{ route('blog') }}">Book</a> (6)</li>
                                    <li class="cat-item cat-item-4"><a href="{{ route('blog') }}">Design</a> (4)</li>
                                    <li class="cat-item cat-item-5"><a href="{{ route('blog') }}">Fashion</a> (3)</li>
                                    <li class="cat-item cat-item-6"><a href="{{ route('blog') }}">Lifestyle</a> (6)</li>
                                    <li class="cat-item cat-item-7"><a href="{{ route('blog') }}">Travel</a> (2)</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-widget widget_tags mb-50">
                            ...
                            <div class="tagcloud">
                                <a class="tag-cloud-link" href="{{ route('blog') }}">beautiful</a>
                                <a class="tag-cloud-link" href="{{ route('blog') }}">New York</a>
                                <a class="tag-cloud-link" href="{{ route('blog') }}">droll</a>
                                <a class="tag-cloud-link" href="{{ route('blog') }}">intimate</a>
                                <a class="tag-cloud-link" href="{{ route('blog') }}">loving</a>
                                <a class="tag-cloud-link" href="{{ route('blog') }}">travel</a>
                                <a class="tag-cloud-link" href="{{ route('blog') }}">fighting </a>
                            </div>
                        </div>
                    </div>
                </div>
