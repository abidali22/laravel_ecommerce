    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                <a href="{{ route('homesss')}}" rel="nofollow">Home</a>
                <span></span> Fashion
                        ...
                        <div class="row mt-60">
                            ...
                            <div class="col-12">
                                <div class="row related-products">
                                    @foreach($reltvProducts as $rltData)
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap small hover-up">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="product-details.html" tabindex="0">{{$rltData->name}}</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                    </span>
                                                </div>
                                                <div class="product-price">
                                                    <span>${{$rltData->regular_price}} </span>
                        ...
                        @foreach($newProducts as $newItems)
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    ...
                                    <p class="price mb-0 mt-5">${{$newItems->regular_price}}</p>
